...
import SNAct1.actions.UncommonPowerAction;
import SNAct1.characters.TheDefault;

import static SNAct1.SNAct1Mod.makeCardPath;
...
public class DefaultUncommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = SNAct1Mod.makeID(DefaultUncommonPower.class.getSimpleName());
