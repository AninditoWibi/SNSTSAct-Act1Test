...
// taken from ruina's ACM implementation with darkglade's permissions
public abstract class AbstractCardMonster extends AbstractSNActsMonster {
    ...
    /* iff i ever add a boss or monster with multi intents..
