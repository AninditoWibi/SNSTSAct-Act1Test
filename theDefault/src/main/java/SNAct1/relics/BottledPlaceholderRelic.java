...
import SNAct1.patches.relics.BottledPlaceholderField;
import SNAct1.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static SNAct1.SNAct1Mod.makeRelicOutlinePath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = SNAct1Mod.makeID("BottledPlaceholderRelic");
